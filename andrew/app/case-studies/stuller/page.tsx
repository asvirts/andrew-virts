    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="relative z-10 h-full max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col justify-center">
          ...
          >
            ...
            <div className="flex items-center gap-2">
              ...
              <span>Role: Lead Web Designer</span>
            </div>
            <div className="flex items-center gap-2">
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <section className="mb-16">
          ...
          <p className="text-gray-600">
            Ordering custom packaging and displays online was a pain point for
            Stuller. Users did not have an easy way to browse custom options and
            the process was not streamlined. It required a lot of back and forth
            with the sales team to get the right product.
          </p>
        </section>
        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Image
              src="https://mjofrqyopzbcipzeghug.supabase.co/storage/v1/object/public/images/Case%20by%20Case%20(1).png"
